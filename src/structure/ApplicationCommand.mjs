export default class ApplicationCommand {
	...
	/**
	 * @param {{
	 *  command: Partial<import("discord.js").APIApplicationCommand>,
	 *  options?: Partial<{
	 *      cooldown?: number,
	 *      botOwner?: boolean,
	 *      guildOwner?: boolean,
	 ...
	 *  }>,
	 *  run: (client: DiscordClient, interaction: import('discord.js').Interaction) => import('discord.js').Awaitable<void>
	 * }} structure
	 */
